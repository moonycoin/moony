  ...
  head: [
    ...
    ['script', {}, `
      ...
      (function() {
        ...
        // Add CSS to hide the outline label text completely
        const hideLabelStyle = document.createElement('style');
        hideLabelStyle.textContent = '.VPDocAside .outline-title { display: none !important; } .VPDocAside .outline-marker { display: none !important; } .VPDocAside .outline { margin-top: 0 !important; }';
